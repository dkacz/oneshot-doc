# Preset: pismo (formal letter, official or business letter)
...
2. **Case reference / subject**: one line ("Dotyczy: ..."), functioning as the title; no large title block, the YAML `title` field stays empty, and the address block is laid out in LaTeX for PDF.
...
- Formal register without antique stiffness; "zwracam się z prośbą" instead of "uprzejmie proszę o łaskawe".
