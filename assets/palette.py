...
WPBLUE = "#253B59"   # primary: titles, main series, emphasis
WPRULE = "#7D93AD"   # secondary: rules, comparison series, frames
WPGRAY = "#4B5563"   # text grey: labels, annotations
WPLIGHT = "#EEF3F8"  # light background fill
BRICK = "#A6442C"    # warning/contrast accent, use sparingly
...
def font_template_values() -> dict[str, str]:
    """Return replacement values for assets/header_template.tex."""
    sans_dir, serif_dir = font_dir_strings()
    return {"SANS_FONT_DIR": sans_dir, "SERIF_FONT_DIR": serif_dir}


def setup_fonts(family: str = SANS_FAMILY) -> None:
    ...
    plt.rcParams["axes.edgecolor"] = WPGRAY
    plt.rcParams["axes.labelcolor"] = WPGRAY
    plt.rcParams["xtick.color"] = WPGRAY
    plt.rcParams["ytick.color"] = WPGRAY
    plt.rcParams["text.color"] = WPGRAY
    plt.rcParams["axes.spines.top"] = False
    plt.rcParams["axes.spines.right"] = False
    plt.rcParams["grid.color"] = WPRULE
